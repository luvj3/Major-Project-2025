...
def fetch_stats(selected_user, df):
    ...
    # Use the media_message column if it exists, otherwise check for '<Media omitted>'
    if 'media_message' in user_df.columns:
        num_media_messages = user_df['media_message'].sum()
    else:
